...
public class JwtUtils {
    ...
    private static final long EXPIRATION_TIME_IN_MILLISEC = 1000L * 60L *60L *24L * 30L * 6L; //expiers 6 months
    ...
    private void init(){
        ...
        this.key = new SecretKeySpec(keyBytes, "HmacSHA256");//assign value to "(key:jwt object)" using hash algo : "HmacSHA256"
    }
